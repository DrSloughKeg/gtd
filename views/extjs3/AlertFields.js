go.modules.tutorial.gtd.AlertFields = Ext.extend(go.form.FormGroup, {
    xtype: "formgroup",
    name: "alerts",
    hideLabel: true,
    iconCls: 'ic-alert',
            ...
            items: [{
                ...
                listeners: {
                    afterrender: function(field) {
                        ...
                        const thoughtDialog = field.findParentByType("window");
                        const start = thoughtDialog.formPanel.form.findField("start");
